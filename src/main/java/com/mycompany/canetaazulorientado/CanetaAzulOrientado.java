 ...
 * Cor: caracter - string = Double - azul
 ...
 * destampar
 * 
 * metodo rabiscar(); MÉTODO SEMPRE VAI TER O ()
 * se (tampada) entao
 * escrever (ERRO)
 * senão
 * escrever (RABISCAR)
 ...
 * CLASSE - FORMA/MOLDE
 * 
 * instanciamento = gerar um objeto a partir de uma classe:
 * c1 = new caneta; (o que vem antes do new é o objeto que vai existir na classe; depois do new é a classe que vou utilizar)
 * 
 ...
 * 
 * 
 * para poder rabiscar com a caneta, precisamos chamar um MÉTODO, que é o comportamento da caneta
 * 
 * c1.escrever();
 * 
 * c2 = new.caneta (para "fazer" outra caneta)
 * que pode ter novos atributos:
 * c2.cor = preto;
 * c2.ponta = 1.0;
 * c2.tampada = true;
 * 
 * método para escrever com a caneta:
 * c2.destampar();
 * 
 * 
 */
